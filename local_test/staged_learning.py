...
for i, params in enumerate(param_list):
    ...
    if not model:
        model = PPO('CnnPolicy', vec_env, policy_kwargs=policy_kwargs, verbose=True, device='cuda', tensorboard_log=log_dir, n_steps=512, batch_size=2048, learning_rate=0.0003)
